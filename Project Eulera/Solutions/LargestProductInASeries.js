...
const largeProductionInASeries = (n, arrOfNums = [...longArr]) => {
  return arrOfNums.reduce((acc, sublineSum, index, arr) => {
    sublineSum = arr.slice(index, index + n).reduce((a, b) => a * b);
    return (acc =
      acc > sublineSum || index + n > arr.length ? acc : sublineSum);
  }, 0);
};
//-------------------------------------------
//++++++
//+++
//===========================================
console.log(largeProductionInASeries(13));
//===========================================
module.exports = largeProductionInASeries;
